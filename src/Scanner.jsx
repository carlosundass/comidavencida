...
const Scanner = ({ onScan, onClose }) => {
  ...
  useEffect(() => {
    ...
    const config = {
      fps: 15,
      qrbox: { width: 250, height: 250 }, // Hice la caja un poco más cuadrada para que los QR entren mejor
      aspectRatio: 1.0, 
      formatsToSupport: [
        ...
        Html5QrcodeSupportedFormats.QR_CODE // ¡AQUÍ AGREGAMOS EL SOPORTE PARA QR!
      ]
    };
...
export default Scanner;import React, { useEffect, useRef, useState } from 'react';
import { Html5Qrcode, Html5QrcodeSupportedFormats } from 'html5-qrcode';
import { X, Zap, AlertCircle, ZoomIn, Camera } from 'lucide-react';
