...
const Dashboard = () => {
  ...
  const generarRecetaMagica = async () => {
    ...
    const prompt = `Chef chileno experto. Tengo esto: ${ingredientes}. Dame una idea de receta rápida en un párrafo corto, con tono amigable y chileno.`;
      ...
      <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-[2rem] p-6 shadow-lg mb-6 text-white relative overflow-hidden transition-all">
        ...
        {recetaIA ? (
          ...
          <div className="relative z-10">
            <p className="font-bold text-sm leading-snug mb-5">Tienes {porVencer.length} alimentos por vencer. ¿Hacemos una receta mágica?</p>
            <button 
  ...
  // ==========================================
  // RENDER PANTALLAS (LOGIN / DASHBOARD)
  // ==========================================
  if (!usuarioActual) {
    return (
